...
const chalk_1 = __webpack_require__(818);
/* eslint-disable no-console */
const log = (message) => console.log(`${chalk_1.green('#')} ${String(message)}`);
exports.log = log;
const logWarn = (message) => console.log(`${chalk_1.yellow('#')} ${String(message)}`);
exports.logWarn = logWarn;
const logError = (message) => console.log(chalk_1.red(`# ${String(message)}`));
...
const log_1 = __webpack_require__(817);
const language_helpers_1 = __webpack_require__(968);
exports.spawnSyncSafe = ((...args) => {
    const spawnResult = child_process_1.spawnSync(...args);
...
function spawnSyncLogged(command, args, options, label = options.cwd || process.cwd()) {
    log_1.log(`${label}: ${command} ${args.join(' ')}`);
    return exports.spawnSyncSafe(command, args, options);
}
